...
session_start();
$lesson = [
    'title' => 'Материал: Тобуроков',
    'parts' => [
        ['title' => 'Биография', 'content' => 'Тобуроков — якутский писатель. Родился в 1914 году.', 'character_img' => 'char1.png'],
        ['title' => 'Творчество', 'content' => 'Писал о природе Якутии и жизни народа.', 'character_img' => 'char2.png'],
        ['title' => 'Произведения', 'content' => 'Основные книги: "На берегах Вилюя", "Долина белых журавлей".', 'character_img' => 'char3.png'],
        ['title' => 'Наследие', 'content' => 'В 2024 году — 110 лет со дня рождения.', 'character_img' => 'char4.png'],
        ['title' => 'Факты', 'content' => 'Его книги переводят на другие языки.', 'character_img' => 'char5.png']
    ]
];
            ...
            <div class="lesson-content">
                <div class="lesson-character-section">
                    <div class="lesson-character-image">
                        <img src="images/character/<?php echo $current_lesson['character_img']; ?>" alt="Макс">
                    </div>
