...
function initCharacterStory() {
    ...
    const storyParts = [
        {
            text: "Здравствуй я перс тест1 ДТК Центр чтения. сейчас пройдём тест о якутском поэте П.Н. Тобурокове",
            title: "Часть 1 из 5: Знакомство",
            imageIndex: 0
        },
        {
            text: "Тест из 8 вопросов. Вам нужно выбрать 1 правильный ответ из 3 вариантов",
        ...
        {
            text: "После прохождения вы увидите результат",
            title: "Часть 4 из 5: Результат",
            imageIndex: 3
        },
        {
            text: "Готовы проверить свои знания ребятишки? Нажмите 'Начать тест' для перехода к вопросам",
